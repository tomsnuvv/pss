...
Nova.booting(function (Vue, router, store) {
  Vue.component('import-stats', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.request().get("/nova-vendor/import-stats/endpoint").then(function (_ref) {
            var data = _ref.data;
...
var render = function() {
  ...
  return _c(
    "card",
    { staticClass: "card relative card-panel" },
    [
      _c("loading-view", { attrs: { loading: _vm.initialLoading } }, [
        _c(
          "div",
          ...
          [
            ...
            _c(
              "div",
              { staticClass: "overflow-hidden overflow-y-auto max-h-90px" },
              [
                _c(
                  "ul",
                      ...
                      return [
                        _c(
                          ...
                          [
                            _c("span", {
                              staticClass:
                                "inline-block rounded-full w-2 h-2 mr-2",
                              class: {
                            ...
                            _vm._v(" "),
                            _c("strong", [_vm._v(_vm._s(stat.module))]),
                            _vm._v(
                              " Executed: " +
                                _vm._s(stat.last_run) +
                                "\n                        "
                            )
                          ]
                        )
