...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-badge', __webpack_require__(3));
    Vue.component('detail-badge', __webpack_require__(6));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    className: function className() {
      return this.value ? this.field.classMap[this.value] : {};
    },
    default: function _default() {
      return this.field.default || '';
    },
    value: function value() {
      return this.field.value ? this.field.value : this.default;
    }
  }
});
...
var render = function() {
  ...
  return _vm.value
    ? _c(
        ...
        {
          staticClass:
            "rounded-full uppercase px-2 py-1 text-xs font-bold mr-3 badge-default",
          class: _vm.className
        },
        [_vm._v("\n    " + _vm._s(_vm.value) + "\n")]
      )
    : _c("span", { staticClass: "text-80" }, [_vm._v("\n    -\n")])
}
var staticRenderFns = []
