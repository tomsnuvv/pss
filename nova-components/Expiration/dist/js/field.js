...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-expiration', __webpack_require__(3));
    Vue.component('detail-expiration', __webpack_require__(6));
});
...
var render = function() {
  ...
  return _c("span", { staticClass: "no-wrap", class: this.field.className }, [
    _vm._v(_vm._s(this.field.expiration))
  ])
}
var staticRenderFns = []
  ...
  return _c(
    ...
    [
      _c("template", { slot: "value" }, [
        _c("span", { staticClass: "no-wrap", class: this.field.className }, [
          _vm._v(_vm._s(this.field.expiration))
        ])
      ])
    ],
